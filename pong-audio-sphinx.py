...
def listen_to_speech():
    ...
    while not quit:
        ...
        with sr.Microphone(device_index=0) as source:
            ...
            try:
                # Using Sphinx recognizer for offline speech recognition
                recog_results = r.recognize_sphinx(audio)
                ...
                print("[speech recognition] Sphinx could not understand audio")
            except sr.RequestError as e:
                print(f"[speech recognition] Sphinx error; {e}")
